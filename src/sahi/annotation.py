...
from sahi.utils.shapely import ShapelyAnnotation, Polygon
...
class Mask:
    ...
    def __str__(self):
        return f"{self._mask.shape} {self.shift_x} {self.shift_y} {self.full_shape_width} {self.full_shape_height}"
